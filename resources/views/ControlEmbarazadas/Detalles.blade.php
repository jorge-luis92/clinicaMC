...
<head>
    ...
    <title>Detalles Seguimiento</title>
</head>
<style>
    /*!
...
<style>
    ...
    @font-face {
        ...
        font-style: normal;
        font-weight: 100;
        src: url(https://fonts.gstatic.com/s/montserrat/v25/JTUHjIg1_i6t8kCHKm4532VJOt5-QNFgpCtr6Xw0aXpsog.woff2) format('woff2');
    ...
    @font-face {
        ...
        font-style: normal;
        font-weight: 100;
        src: url(https://fonts.gstatic.com/s/montserrat/v25/JTUHjIg1_i6t8kCHKm4532VJOt5-QNFgpCtr6Xw9aXpsog.woff2) format('woff2');
    ...
    @font-face {
        ...
        font-style: normal;
        font-weight: 100;
        src: url(https://fonts.gstatic.com/s/montserrat/v25/JTUHjIg1_i6t8kCHKm4532VJOt5-QNFgpCtr6Xw2aXpsog.woff2) format('woff2');
...
$movimiento = $data->movimiento_fetal;
        ...
        <table class="table table-bordered" style="font-size: 8pt; padding: 0;" width="100%">
            <table style="width:100%" align="center">
                <tr>
                    ...
                    <td width="70%" style="font-size: 0.8rem; text-align: left; font-family:  serif;"><strong>Paciente:</strong> {{ $nombre }}&nbsp;&nbsp;&nbsp;&nbsp;
                        <br><a style="font-size: 0.8rem; color:black; text-align: left; font-family:  serif;"><strong>Padecimiento Indicado:</strong></a>
                    </td>
                </tr>
                <tr>
                    <td align="left" style="font-size: 0.8rem; text-align: left; font-family:  serif;"><strong>Edad:</strong> {{ $ed}} <br><strong>Peso:</strong> {{ $peso }}
                        <br><strong>Talla:</strong> {{ $talla }} <br><strong>Temperatura:</strong>
                        <br><strong>T/A:</strong> {{ $ta }} <br> <strong>Glucosa:</strong>
                    </td>
                    <td>
                        <p style="text-align: left; font-size: .8rem; font-family:  serif;"> <strong>DIAGN&Oacute;STICO:</strong>  </p>
                        <p style="text-align: left; font-size: .8rem; font-family:  serif;"> <strong>Examen F&iacute;sico:</strong>  <br>
                            <a style="text-align: left; font-size: .8rem; font-family:  serif; color: black;"> <strong>{{ $procedimiento }}</strong> {{ $pro }} </a>
                        <p style="text-align: left; font-size: .8rem; font-family:  serif;"> <strong>Recomendaciones:</strong> {{ $recomendaciones }} </p>
                    </td>
                </tr>
            </table>
        </table>
