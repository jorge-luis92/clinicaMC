...
<head>
    <meta charset="UTF-8">
    <title>Receta Médica - {{ $consulta->nombre_completo }}</title>
    <style>
        ...
        <tr>
            <td valign="top" style="padding: 0;">
                ...
                <table class="header">
                    <tr>
                        <td width="80%">
                            <h1 class="doc-name">{{ $medico->genero == 'M' ? 'Dra.' : 'Dr.' }} {{ $medico->nombre }} {{ $medico->ap_paterno }} {{ $medico->ap_materno }}</h1>
                ...
                <table class="split-layout">
                    <tr>
                        ...
                        <td class="col-main">
                            ...
                            @else
                                <div style="text-align: center; color: #94a3b8; font-style: italic; font-size: 9.5pt; margin-bottom: 15px;">
            ...
            <td valign="bottom" style="height: 65px; padding: 0;">
                <div class="footer-container">
                    ...
                    <div class="clinic-info">
                        Servicios Médicos San Agustín • Oaxaca • Tel: {{ $medico->celular }}
                    </div>
                </div>
            </td>
        </tr>
