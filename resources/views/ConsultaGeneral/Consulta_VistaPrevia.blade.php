    ...
    <div class="table-responsive" id="estilo_mio">
        <table class="table table-bordered" style="font-size: 9pt; padding: 0;" width="100%">
            <table style="width:100%" align="center">
                ...
                <tr>
                    <td align="left"><strong>Edad:</strong> {{ $ed}} <br><strong>Peso:</strong> {{ $peso }}
                    ...
                    <td>
                        <p style="text-align: left; font-size: .8rem;"> <strong>DIAGN&Oacute;STICO:</strong> {{ $diag }} </p>
                        <br>
                        <p style="text-align: left; font-size: .8rem;"> <strong>Examen F&iacute;sico:</strong> {{ $examen }} </p>
                        <p style="text-align: left; font-size: .8rem;"> <strong>Recomendaciones:</strong> {{ $rec }} </p>
                    </td>
                </tr>
            </table>
        </table>
