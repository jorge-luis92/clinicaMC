...
<body id="page-top">
  <div id="wrapper" style="font-family: 'Century Gothic';">
    ...
    <div id="content-wrapper" class="d-flex flex-column" style="background-image: url('/image/fondo_inicio.png'); background-position:center; background-repeat: no-repeat; position: relative; background-color: #FFFFFF; background-size: contain;"">
      <div id="content">
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li>
              <a class="navbar" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                ...
                <h1 class="mr-2 d-none d-lg-inline" style="color: #0B173B;font-size: 35px;">&nbsp;Servicios M&eacute;dicos y Laboratorio "San Agust&iacute;n"</h1>
              </a>
            </li>
